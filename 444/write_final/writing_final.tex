...
\includepdf[pages=-]{writing_1.pdf}
%\subsection{I/O and Provided Functionality}
\includepdf[pages=-]{writing_2.pdf}
%\subsection{Interrupts}
\includepdf[pages=-]{writing_3.pdf}
%\subsection{Memory Management}
\includepdf[pages=-]{writing_4.pdf}
%\subsection{File Systems}
\includepdf[pages=-]{writing_5.pdf}
\end{document}
